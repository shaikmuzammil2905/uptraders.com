...
function ContactForm() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (!validate()) return;
    const text = `*New Message from UP Traders Website*%0A%0A*Name:* ${encodeURIComponent(form.name)}%0A*Email:* ${encodeURIComponent(form.email || 'Not provided')}%0A*Subject:* ${encodeURIComponent(form.subject)}%0A%0A*Message:*%0A${encodeURIComponent(form.message)}`;
          ...
          >
            ...
            <div className="bg-white border border-brand-red/10 rounded-2xl p-6 flex items-start gap-5 shadow-sm hover:shadow-lg transition-shadow">
              ...
              <div>
                ...
                <p className="text-gray-900/70 text-sm">+91 98660 48155<br />+91 93902 68250</p>
                <p className="text-gray-900/40 text-xs mt-1">Mon–Sun, 7:00 AM – 10:00 PM</p>
              </div>
            </div>
            ...
            <div className="bg-white border border-brand-red/10 rounded-2xl p-6 flex items-start gap-5 shadow-sm hover:shadow-lg transition-shadow">
              ...
              <div>
                ...
                <p className="text-gray-900/70 text-sm">uptraders.official@gmail.com</p>
